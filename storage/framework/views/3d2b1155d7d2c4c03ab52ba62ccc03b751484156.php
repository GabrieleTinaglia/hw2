...
<meta http-equiv="Cache-control" content="no-cache">
    ...
    <script src="<?php echo e(asset('js/altlogjs.js')); ?>" defer></script>
    <link rel="stylesheet" href="<?php echo e(asset('css/altlog.css')); ?>">
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form name="register" id="registra" method="POST">
                ...
                <div class="area"><e class="errorUser"> </e><e class="errorEm">                <?php if(Session()->has('errors')): ?>
