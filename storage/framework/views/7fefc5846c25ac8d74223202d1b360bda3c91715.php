<html>
    ...
    <?php endif; ?>
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/prenota.css')); ?>">
            ...
            <script src="<?php echo e(asset('js/jsprenota.js')); ?>" defer="true">
            </script>
    ...
    </html><?php /**PATH C:\xampp\htdocs\laravel\resources\views/prenota.blade.php ENDPATH**/ ?>